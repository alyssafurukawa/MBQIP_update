...
edtc_table <- kable(table_data, format = "latex", booktabs = TRUE, linesep="") %>%
  kable_styling(latex_options = c("striped","scale_down", "HOLD_position"), stripe_index = c(1,3,5,7,9),
                position = "center",
                font_size = 11 #, #stripe_color = "#ddf1f7" 2024-06-24: removing color for the moment
                ) |> 
  ...
  #row_spec(10, color = "#14416d") 2024-06-24: removing color for the moment
...
table2 <- kable(table2_data, format = "latex", booktabs = TRUE, linesep="", align = c("l", "l", rep("c", 10))) %>%
  ...
  #row_spec(c(1), background = "#ddf1f7") 2024-06-24: removing color for the moment
...
table3 <- kable(table3_data, format = "latex", booktabs = TRUE, linesep="", align = c("l", "l", rep("c", 9))) %>%
 ...
 # row_spec(1, background = "#ddf1f7") 2024-06-24: removing color for the moment
...
```{r create quality infrastructure , echo=FALSE, results="hide", message=FALSE, warning=FALSE, include=TRUE}
